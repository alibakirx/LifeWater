...
const LifeWater: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const sketch = (p: any) => {
      ...
      function separate(creature: Creature, index: number): any {
      ...
      function align(creature: Creature, index: number): any {
      ...
      function cohere(creature: Creature, index: number): any {
        const neighborDist = 50;
        const sum = p.createVector(0, 0);
        let count = 0;
